...
import { loadPackDoc } from '../../modpack/compile.js'
...
/** DSH ToolRuntime.register requires output.render; aligned to @deepseek-ai/dsh-tools 0.1.0-rc.7. execute may receive exec.signal. */
