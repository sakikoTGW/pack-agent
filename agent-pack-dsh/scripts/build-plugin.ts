...
const entry = join(root, 'agent-pack-dsh', 'plugin', 'src', 'index.ts')
const outfile = join(root, 'agent-pack-dsh', 'plugin', 'lib', 'index.js')
mkdirSync(join(root, 'agent-pack-dsh', 'plugin', 'lib'), { recursive: true })
